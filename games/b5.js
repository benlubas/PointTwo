...
Array.prototype.random = function() {
  return this[ran(0, this.length - 1)];
};
Array.prototype.includesPoint = function(pt) {
  for (let i = 0; i < this.length; i++) {
    if (this[i].equals(pt)) return i;
  }
  return -1;
};
...
function createCanvas(x, y, z) {
  if (x != undefined && y != undefined && z != undefined) {
    ...
    $("body").prepend($node);
    con = getCon("canvas");
  } else console.error("SYNTAX ERROR createCanvas, b5.js line 720ish");
}

...
const graph = function(f, xmin, xmax, n) {
  createCanvas("graph" + (n === undefined ? "" : n), 420, 220);
  let c = getCon("graph" + (n === undefined ? "" : n));
  c.beginPath(); //background
  c.rect(0, 0, 420, 220);
  c.fillStyle = "#CCCCCC";
  c.fill();
  c.closePath();
  let y = []; //                   Distance between them split into 400 parts b/c 400px wide.
  for (let i = xmin; i < xmax; i += Math.abs(xmin - xmax) / 400) {
    y.push(f(i));
  }
  ...
  for (let i = 1; i < y.length; i++) {
    c.beginPath();
    c.moveTo(i + 9, 200 - map(y[i - 1], ymin, ymax, 0, 200) + 10);
    c.lineTo(i + 10, 200 - map(y[i], ymin, ymax, 0, 200) + 10);
    c.stroke();
    c.closePath();
  }
};
...
Point.prototype.lineTo = function(pt, c, a) {
  if (c === undefined && a === undefined) {
    ...
    con.moveTo(this.x, this.y);
    con.lineTo(pt.x, pt.y);
    let aS = Math.abs(a).toString(16);
    let color = "" + c + aS.substring(2, 4);
    console.log(color);
    stroke(color, 1);
    end();
  }
...
const arrIncludesPoint = function(arr, pt) {
...
const arrPointDupCheck = function(arr) {
  for (let i = 0; i < arr.length; i++) {
...
function getQuadrent(origin, point) {
  ...
  else if (point.x > origin.x && point.y > origin.y) return 4;
  else return 0; //if 0 is returned, the point is on an axis
}
function adjustAngle(a, q) {
  return q === 0 ? a + 90 * (q - 1) : a; //This IS, infact, an if else statement.
}
...
function keyDownHandler(e) {
  ...
  switch (e.keyCode) {
    case 13:
      k.enter = true;
      k.keys[29].pressed = true;
      break;
    case 32:
      k.space = true;
      k.keys[30].pressed = true;
      break;
    case 16:
      k.keys[26].pressed = true;
      break;
    case 20:
      k.keys[27].pressed = true;
      break;
    case 9:
      k.keys[28].pressed = true;
      e.preventDefault();
      break;
    case 219:
      k.keys[31].pressed = true;
      break;
    case 221:
      k.keys[32].pressed = true;
      break;
    case 220:
      k.keys[33].pressed = true;
      break;
    case 186:
      k.keys[34].pressed = true;
      break;
    case 222:
      k.keys[35].pressed = true;
      break;
    case 188:
      k.keys[36].pressed = true;
      break;
    case 190:
      k.keys[37].pressed = true;
      break;
    case 191:
      k.keys[38].pressed = true;
      break;
    case 8:
      k.keys[39].pressed = true;
      break;

    case 48:
      k.zero = true;
      k.keys[49].pressed = true;
      break;
    case 49:
      k.one = true;
      k.keys[40].pressed = true;
      break;
    case 50:
      k.two = true;
      k.keys[41].pressed = true;
      break;
    case 51:
      k.three = true;
      k.keys[42].pressed = true;
      break;
    case 52:
      k.four = true;
      k.keys[43].pressed = true;
      break;
    case 53:
      k.five = true;
      k.keys[44].pressed = true;
      break;
    case 54:
      k.six = true;
      k.keys[45].pressed = true;
      break;
    case 55:
      k.seven = true;
      k.keys[46].pressed = true;
      break;
    case 56:
      k.eight = true;
      k.keys[47].pressed = true;
      break;
    case 57:
      k.nine = true;
      k.keys[48].pressed = true;
      break;

    case 65:
      k.a = true;
      k.keys[0].pressed = true;
      break;
    case 66:
      k.b = true;
      k.keys[1].pressed = true;
      break;
    case 67:
      k.c = true;
      k.keys[2].pressed = true;
      break;
    case 68:
      k.d = true;
      k.keys[3].pressed = true;
      break;
    case 69:
      k.e = true;
      k.keys[4].pressed = true;
      break;
    case 70:
      k.f = true;
      k.keys[5].pressed = true;
      break;
    case 71:
      k.g = true;
      k.keys[6].pressed = true;
      break;
    case 72:
      k.h = true;
      k.keys[7].pressed = true;
      break;
    case 73:
      k.i = true;
      k.keys[8].pressed = true;
      break;
    case 74:
      k.j = true;
      k.keys[9].pressed = true;
      break;
    case 75:
      k.k = true;
      k.keys[10].pressed = true;
      break;
    case 76:
      k.l = true;
      k.keys[11].pressed = true;
      break;
    case 77:
      k.m = true;
      k.keys[12].pressed = true;
      break;
    case 78:
      k.n = true;
      k.keys[13].pressed = true;
      break;
    case 79:
      k.o = true;
      k.keys[14].pressed = true;
      break;
    case 80:
      k.p = true;
      k.keys[15].pressed = true;
      break;
    case 81:
      k.q = true;
      k.keys[16].pressed = true;
      break;
    case 82:
      k.r = true;
      k.keys[17].pressed = true;
      break;
    case 83:
      k.s = true;
      k.keys[18].pressed = true;
      break;
    case 84:
      k.t = true;
      k.keys[19].pressed = true;
      break;
    case 85:
      k.u = true;
      k.keys[20].pressed = true;
      break;
    case 86:
      k.v = true;
      k.keys[21].pressed = true;
      break;
    case 87:
      k.w = true;
      k.keys[22].pressed = true;
      break;
    case 88:
      k.x = true;
      k.keys[23].pressed = true;
      break;
    case 89:
      k.y = true;
      k.keys[24].pressed = true;
      break;
    case 90:
      k.z = true;
      k.keys[25].pressed = true;
      break;
  }
}
...
function keyUpHandler(e) {
  ...
  switch (e.keyCode) {
    case 13:
      k.enter = false;
      k.keys[29].pressed = false;
      break;
    case 32:
      k.space = false;
      k.keys[30].pressed = false;
      break;
    case 16:
      k.keys[26].pressed = false;
      break;
    case 20:
      k.keys[27].pressed = false;
      break;
    case 9:
      k.keys[28].pressed = false;
      break;
    case 219:
      k.keys[31].pressed = false;
      break;
    case 221:
      k.keys[32].pressed = false;
      break;
    case 220:
      k.keys[33].pressed = false;
      break;
    case 186:
      k.keys[34].pressed = false;
      break;
    case 222:
      k.keys[35].pressed = false;
      break;
    case 188:
      k.keys[36].pressed = false;
      break;
    case 190:
      k.keys[37].pressed = false;
      break;
    case 191:
      k.keys[38].pressed = false;
      break;
    case 8:
      k.keys[39].pressed = false;
      break;

    case 48:
      k.zero = false;
      k.keys[49].pressed = false;
      break;
    case 49:
      k.one = false;
      k.keys[40].pressed = false;
      break;
    case 50:
      k.two = false;
      k.keys[41].pressed = false;
      break;
    case 51:
      k.three = false;
      k.keys[42].pressed = false;
      break;
    case 52:
      k.four = false;
      k.keys[43].pressed = false;
      break;
    case 53:
      k.five = false;
      k.keys[44].pressed = false;
      break;
    case 54:
      k.six = false;
      k.keys[45].pressed = false;
      break;
    case 55:
      k.seven = false;
      k.keys[46].pressed = false;
      break;
    case 56:
      k.eight = false;
      k.keys[47].pressed = false;
      break;
    case 57:
      k.nine = false;
      k.keys[48].pressed = false;
      break;
    ...
    case 70:
      k.f = false;
      k.keys[5].pressed = false;
      break;
    case 71:
      k.g = false;
      k.keys[6].pressed = false;
      break;
    case 72:
      k.h = false;
      k.keys[7].pressed = false;
      break;
    case 73:
      k.i = false;
      k.keys[8].pressed = false;
      break;
    case 74:
      k.j = false;
      k.keys[9].pressed = false;
      break;
    case 75:
      k.k = false;
      k.keys[10].pressed = false;
      break;
    case 76:
      k.l = false;
      k.keys[11].pressed = false;
      break;
    case 77:
      k.m = false;
      k.keys[12].pressed = false;
      break;
    case 78:
      k.n = false;
      k.keys[13].pressed = false;
      break;
    case 79:
      k.o = false;
      k.keys[14].pressed = false;
      break;
    case 80:
      k.p = false;
      k.keys[15].pressed = false;
      break;
    case 81:
      k.q = false;
      k.keys[16].pressed = false;
      break;
    case 82:
      k.r = false;
      k.keys[17].pressed = false;
      break;
    case 83:
      k.s = false;
      k.keys[18].pressed = false;
      break;
    case 84:
      k.t = false;
      k.keys[19].pressed = false;
      break;
    case 85:
      k.u = false;
      k.keys[20].pressed = false;
      break;
    case 86:
      k.v = false;
      k.keys[21].pressed = false;
      break;
    case 87:
      k.w = false;
      k.keys[22].pressed = false;
      break;
    case 88:
      k.x = false;
      k.keys[23].pressed = false;
      break;
    case 89:
      k.y = false;
      k.keys[24].pressed = false;
      break;
    case 90:
      k.z = false;
      k.keys[25].pressed = false;
      break;
  }
}
...
function Mouse(x, y) {
  ...
  this.draw = function() {
    circle(true, this.pos.x, this.pos.y, this.radius, "white");
...
function createCanvas(x, y, z) {
  if (x != undefined && y != undefined && z != undefined) {
    //ALL PARAMS, ID WIDTH AND HEIGHT:
    $node = $("<canvas></canvas>");
    $node.attr("id", x);
    $node.attr("height", z + "px");
    $node.attr("width", y + "px");
    $("body").prepend($node);
  } else if (x != undefined && y == undefined) {
    // just id, default 400 by 400px
    $node = $("<canvas></canvas>");
    $node.attr("id", x);
    $node.attr("height", "400px");
    $node.attr("width", "400px");
    $("body").prepend($node);
  } else if (z == undefined && y != undefined && x != undefined) {
    // just width and height sent in
    $node = $("<canvas></canvas>");
    $node.attr("id", "canvas");
    $node.attr("height", y + "px");
    $node.attr("width", x + "px");
    $("body").prepend($node);
  } else console.error("SYNTAX ERROR createCanvas, b5.js line 750ish");
}
